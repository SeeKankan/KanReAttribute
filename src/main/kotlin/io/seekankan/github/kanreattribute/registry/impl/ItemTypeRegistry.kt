...
) : CopyOnWriteRegistry<ItemType, ItemTypeTag>() {
    override val registerableTypeName: String = "ItemType"
    override val uniqueName: NamespacedKeyOf<RegistryTag> = registryKeyOf(pluginInfo, "item_type")
