...
class EffectApplierRegistry(
    private val pluginInfo: PluginInfo
): CopyOnWriteRegistry<EffectApplier, EffectApplierTag>() {
    override val registerableTypeName: String = "EffectApplier"
    override val uniqueName: NamespacedKeyOf<RegistryTag> = registryKeyOf(pluginInfo, "effect_applier")
}