...
import io.seekankan.github.kanreattribute.command.legacy.admin.SubAdminCommand
...
//    }
    ...
    fun setupCommand() {
        val command = (plugin as JavaPlugin).getCommand("kanreattributelegacy") ?: throw IllegalStateException("Cannot find /kanreattribute command")
